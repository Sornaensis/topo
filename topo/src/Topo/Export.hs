...
-- | Canonical JSON export field names for climate/weather values whose
-- temporal basis would otherwise be ambiguous.
canonicalBasisQualifiedExportFields :: [Text]
canonicalBasisQualifiedExportFields =
  [ "climate_temp_avg"
  , "climate_precip_avg"
  , "climate_humidity_avg"
  , "climate_wind_dir_avg"
  , "climate_wind_spd_avg"
  , "weather_temp_current"
  , "weather_humidity_current"
  , "weather_wind_dir_current"
  , "weather_wind_spd_current"
  , "weather_pressure_current"
  , "weather_precip_current"
  , "weather_cloud_cover_current"
  , "weather_cloud_water_current"
  , "weather_cloud_cover_low_current"
  , "weather_cloud_cover_mid_current"
  , "weather_cloud_cover_high_current"
  , "weather_cloud_water_low_current"
  , "weather_cloud_water_mid_current"
  , "weather_cloud_water_high_current"
  , "weather_temp_typical"
  , "weather_humidity_typical"
  , "weather_wind_dir_typical"
  , "weather_wind_spd_typical"
  , "weather_precip_typical"
  , "weather_cloud_cover_typical"
  , "weather_cloud_water_typical"
  , "weather_cloud_cover_low_typical"
  , "weather_cloud_cover_mid_typical"
  , "weather_cloud_cover_high_typical"
