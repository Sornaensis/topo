...
tooltipForWidget WidgetViewWeather       = Just "Current weather temperature; use Cloud/Storm for aggregate cloud cover and storm tint"
...
tooltipForWidget WidgetViewCloud         = Just "Aggregate cloud cover/cloud water with precipitation storm tint"
