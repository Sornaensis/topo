...
tooltipForWidget WidgetViewOverlayNone        = Just "Disable weather and sky overlay"
tooltipForWidget WidgetViewOverlayTemperature = Just "Overlay weather temperature on the selected base view"
tooltipForWidget WidgetViewOverlayPrecipitation = Just "Overlay precipitation on the selected base view"
tooltipForWidget WidgetViewOverlayCloud       = Just "Overlay aggregate cloud cover/storm tint on the selected base view"
tooltipForWidget WidgetViewBasisAverage       = Just "Use average/generated weather basis when available"
tooltipForWidget WidgetViewBasisCurrent       = Just "Use current simulated weather basis when available"
tooltipForWidget WidgetViewElevation     = Just "Elevation view"
tooltipForWidget WidgetViewBiome         = Just "Biome classification view"
tooltipForWidget WidgetViewClimate       = Just "Average climate temperature"
tooltipForWidget WidgetViewWeather       = Just "Current weather temperature; use Current Cloud for aggregate cloud cover and storm tint"
tooltipForWidget WidgetViewMoisture      = Just "Soil moisture"
tooltipForWidget WidgetViewPrecip        = Just "Average climate precipitation"
tooltipForWidget WidgetViewPrecipCurrent = Just "Current simulated weather precipitation"
...
tooltipForWidget WidgetViewCloud         = Just "Current aggregate cloud cover/cloud water with precipitation storm tint"
tooltipForWidget WidgetViewCloudTypical  = Just "Typical generated cloud normal; unavailable if weather_normals are absent"
