...
sliderBindings =
  ...
  , bindConfigAndSnapshot (terrainFormFloat SliderTfcPlateauMaxMicroRelief uiTfcPlateauMaxMicroRelief (\value terrainForm -> terrainForm { tfcPlateauMaxMicroRelief = value })) (snapshotFloat SliderTfcPlateauMaxMicroRelief (tfcPlateauMaxMicroRelief . scForm))
  , bindConfigAndSnapshot (terrainFormFloat SliderTfcRollingNearFactor uiTfcRollingNearFactor (\value terrainForm -> terrainForm { tfcRollingNearFactor = value })) (snapshotFloat SliderTfcRollingNearFactor (tfcRollingNearFactor . scForm))
