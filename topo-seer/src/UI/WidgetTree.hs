...
buildSliderRowWidgets layout = (terrain, planet, climate, weather, biome, erosion)
  where
    ...
    terrain =
      ...
      , row WidgetConfigGenCoordScaleMinus 1
      , row WidgetConfigGenOffsetXMinus 2
      , row WidgetConfigGenOffsetYMinus 3
      , row WidgetConfigGenFrequencyMinus 4
      , row WidgetConfigGenOctavesMinus 5
      , row WidgetConfigGenLacunarityMinus 6
      , row WidgetConfigGenGainMinus 7
      , row WidgetConfigGenWarpScaleMinus 8
      , row WidgetConfigGenWarpStrengthMinus 9
      , row WidgetConfigExtentXMinus 10
      , row WidgetConfigExtentYMinus 11
      , row WidgetConfigEdgeNorthMinus 12
      , row WidgetConfigEdgeSouthMinus 13
      , row WidgetConfigEdgeEastMinus 14
      , row WidgetConfigEdgeWestMinus 15
      , row WidgetConfigEdgeFalloffMinus 16
      , row WidgetConfigPlateSizeMinus 17
      , row WidgetConfigUpliftMinus 18
      , row WidgetConfigRiftDepthMinus 19
      , row WidgetConfigDetailScaleMinus 20
      , row WidgetConfigPlateSpeedMinus 21
      , row WidgetConfigBoundarySharpnessMinus 22
      , row WidgetConfigBoundaryNoiseScaleMinus 23
      , row WidgetConfigBoundaryNoiseStrengthMinus 24
      , row WidgetConfigBoundaryWarpOctavesMinus 25
      , row WidgetConfigBoundaryWarpLacunarityMinus 26
      , row WidgetConfigBoundaryWarpGainMinus 27
      , row WidgetConfigPlateMergeScaleMinus 28
      , row WidgetConfigPlateMergeBiasMinus 29
      , row WidgetConfigPlateDetailScaleMinus 30
      , row WidgetConfigPlateDetailStrengthMinus 31
      , row WidgetConfigPlateRidgeStrengthMinus 32
      , row WidgetConfigPlateHeightBaseMinus 33
      , row WidgetConfigPlateHeightVarianceMinus 34
      , row WidgetConfigPlateHardnessBaseMinus 35
      , row WidgetConfigPlateHardnessVarianceMinus 36
      , row WidgetConfigTrenchDepthMinus 37
      , row WidgetConfigRidgeHeightMinus 38
      , row WidgetConfigPlateBiasStrengthMinus 39
      , row WidgetConfigPlateBiasCenterMinus 40
      , row WidgetConfigPlateBiasEdgeMinus 41
      , row WidgetConfigPlateBiasNorthMinus 42
      , row WidgetConfigPlateBiasSouthMinus 43
      , row WidgetConfigTfcCliffSlopeMinus 44
      , row WidgetConfigTfcMountainSlopeMinus 45
      , row WidgetConfigTfcMountainReliefMinus 46
